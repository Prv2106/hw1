            ...
            <section>
                ...
                <main>
                    <form name= "signup"   method= "post">
                        <span><label>Nome</label><input type='text' name='name'><div id="name-error"></div></span>
                        <span><label>Cognome</label><input type='text' name='surname'><div id="surname-error"></div></span>
                        <span><label>E-mail</label><input type='text' name='email'><div id="email-error"></div></span>
