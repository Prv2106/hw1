...
function onFocus(event){
    let element = event.currentTarget;
    if((element.value === "nome del film")||(element.value === "Consiglio a tutti di guardare questo film!!!")){
        element.value="";
    }
}
...
function onFocusUpdateMsg(event){
    ...
    document.querySelector('#input-text').removeEventListener('click',onFocusUpdateMsg);
}
