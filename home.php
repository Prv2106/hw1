        ...
        <article id="home">
            ...
            <article data-section="search-mobile">
                ...
                <form id ="search-mobile">
                    ...
                    <input type='submit' id='submit-mobile' value='Cerca'>
                </form>
            </article>
            ...
            <article data-section = "movies">
                <section id = "movies-view"></section>
            ...
            <article data-section="movie-soundtrack">
                <h1>Colonne sonore</h1>
                <div>Qui puoi cercare le playlist di spotify contenti le colonne sonore dei tuoi film,serie e anime preferiti!</div>
                <form id="soundtrack">
                    <input type='text' id='movie-soundtrack' value = "nome del film">
                    <input type='submit' id='submit' value='Cerca'>
                </form>
                <section id = "movie-soundtrack-view"></section>
            </article>
